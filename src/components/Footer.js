...
const Footer = () => {
    return (
        <div class="container-fluid bgc mt-5 pt-5">
            <footer class="row">
                <div class="col mb-3">
                    <a href="#home" class="d-flex align-items-center ms-5 mb-3 text-decoration-none">
                ...
                <h5 className='fs-2'>Quick Links</h5>
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#branches" class="nav-link p-0 text-muted">Location</a></li>
                        <li class="nav-item mb-2"><a href="#careers" class="nav-link p-0 text-muted">Careers</a></li>
                        <li class="nav-item mb-2"><a href="#branches" class="nav-link p-0 text-muted">Branches</a></li>
